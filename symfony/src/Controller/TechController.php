...
{
    #[Route('/tech/profil', name: 'profil_tech')]
    public function connexion_tech(): Response
    {
    ...
    /*#[Route('/tech/inventaire', name: 'inventaire')]
    ...
    #[Route('/tech/inventaire/lister_salles/{ok?1}', name: 'listerSalles')]
    ...
    #[Route('/tech/inventaire/lister_systemes', name: 'listerSystemes')]
    ...
    #[Route('/tech/inventaire/lister_capteurs', name: 'listerCapteurs')]
    ...
    #[Route('/tech/inventaire/ajouter_capteur', name: 'ajouterCapteur')]
    ...
    #[Route('/tech/inventaire/ajouter_salle', name: 'ajouter_salle')]
    ...
    #[Route('/tech/inventaire/ajouter_systeme', name: 'ajouterSystemes')]
    ...
    #[Route('/tech/inventaire/modifier_systeme/{id?}', name: 'modifierSystemes')]
    ...
    #[Route('/tech/inventaire/modifier_salle/{id?}', name: 'modifierSalles')]
    ...
    #[Route('/tech/inventaire/modifier_capteur/{id?}', name: 'modifierCapteurs')]
    ...
    #[Route('/tech/inventaire/supprimer_capteur/{id?}', name: 'supprimerCapteur')]
    ...
    #[Route('/tech/inventaire/supprimer_systeme/{id?}', name: 'supprimerSysteme')]
    ...
    #[Route('/tech/inventaire/supprimer_salle/{id?}', name: 'supprimerSalle')]
    ...
    #[Route('tech/selection_salle', name: 'selectionSalle')]
    ...
    #[Route('/tech/donnees_salle_admin/{room?}', name: 'donneesSalleAdmin')]
    ...
    #[Route('/tech/alerte/{roomId?}/{id?}', name: 'alerteAdmin')]
    ...
    #[Route('tech/suivi/selection_salle', name: 'suivi_selectionSalle')]
    ...
    #[Route('/tech/suivi/graphique/{room?}', name: 'graph_admin')]
