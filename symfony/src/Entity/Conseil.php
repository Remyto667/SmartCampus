...
class Conseil
{
    ...
    #[ORM\Column]
    private ?bool $temp_alerte_min = null;
    ...
    public function isTempAlerteMin(): ?bool
    {
        return $this->temp_alerte_min;
    }

    public function setTempAlerteMin(bool $temp_alerte_min): self
    {
        $this->temp_alerte_min = $temp_alerte_min;
